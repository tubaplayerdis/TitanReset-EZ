...
tr_chassis::tr_chassis(pros::Imu *inertial, ez::Drive* chas ,std::array<tr_sensor *,4> sensors) : options(default_options), active_sensors(0), b_display(false), location_task(nullptr)
{
    north = sensors.at(0);
    east = sensors.at(1);
    south = sensors.at(2);
